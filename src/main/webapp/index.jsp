...
<body>
    <div class="container">
        <div class="content">
            <h1Hello ... ! <span class="name">Recruters !</span></h1>
            <p>My name is <span class="highlighted-name">G V Riteesh Reddy</span>, I am an <span class="trainer">DevOps Engineer</span>.</p>
